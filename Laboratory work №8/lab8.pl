...
% ЗАДАНИЕ 7
task7:-see('F:/task7.txt'),read_list_str(List,_),seen,del_chisla(List, List1),kol_slov_str(List1, L),sort1(List1, L,[]).
...
del_([H|T], Temp, List,0):-append(Temp,[H], Temp1), del_(T, Temp1, List,0),!.
